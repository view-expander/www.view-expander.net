...
export type SiteMetadataQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'author' | 'blogPostPagePath' | 'description' | 'title' | 'instagram' | 'tagsPagePath' | 'twitter' | 'typekitId'>> }> };
...
export type IndexPageQuery = { allContentfulBlogPost: { edges: Array<{ node: (
        ...
        & { pictures?: Maybe<Array<Maybe<Pick<ContentfulBlogPostPicturesJsonNode, 'height' | 'key' | 'width'>>>>, tags?: Maybe<Array<Maybe<Pick<ContentfulTag, 'name' | 'slug'>>>>, body?: Maybe<{ childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'html'>> }> }
      ) }> } };
...
export type BlogPostQuery = { contentfulBlogPost?: Maybe<(
    Pick<ContentfulBlogPost, 'title' | 'slug' | 'date'>
    & { pictures?: Maybe<Array<Maybe<Pick<ContentfulBlogPostPicturesJsonNode, 'height' | 'key' | 'width'>>>>, tags?: Maybe<Array<Maybe<Pick<ContentfulTag, 'name' | 'slug'>>>>, body?: Maybe<{ childMarkdownRemark?: Maybe<Pick<MarkdownRemark, 'html' | 'excerpt'>> }> }
